...
public class ManageSelectPeopleAdapter extends RecyclerView.Adapter<ManageSelectPeopleAdapter.ManagePeopleAdapter> implements Filterable {
    ...
    public ManageSelectPeopleAdapter(Context context,List<PeopleData> mPeopleAdapter){
    ...
    @NonNull
    @Override
    public ManagePeopleAdapter onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view;
        ...
        return new ManagePeopleAdapter(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ManagePeopleAdapter peopleAdapter, final int i) {
                    ...
                    if (constraint != null && constraint.toString().trim().length() > 0) {
                        ...
                        for (int i = 0; i < peopleDataList.size(); i++) {
                            ...
                            if (content.contains(String.valueOf(constraint))) {
                                ...
                                data.setCheckInTime(peopleDataList.get(i).getCheckInTime());
    ...
    public static class ManagePeopleAdapter extends RecyclerView.ViewHolder{
        TextView tv_userName;
        TextView tv_notice;
        CardView tv_cardView;
        public ManagePeopleAdapter(@NonNull View itemView) {
            super(itemView);
